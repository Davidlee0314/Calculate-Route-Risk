...
int main() {
    ...
    Circle c1 = Circle(12, 8, 7, 3);
    Circle c2 = Circle(2, 8, 6, 3);
    Circle c3 = Circle(8, 16, 4, 3);
...
Point findVoronoiPoint(Circle c1, Circle c2, Circle c3){
    ...
    double y = round((weight * temp[0][2] + temp[1][2]) / (weight * temp[0][1] + temp[1][1]));
    double x = round((temp[0][2] - temp[0][1] * y) / temp[0][0]);
